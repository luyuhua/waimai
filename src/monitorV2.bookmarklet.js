...
;(function () {
  ...
  createPanel() {
    ...
    style.textContent = [
      ...
      '.waimai-strategy label { display: flex; align-items: center; gap: 6px; padding: 2px 0; cursor: pointer; color: #ccc; font-size: 13px; }',
      '.waimai-strategy input[type="radio"] { accent-color: #667eea; }',
      '.waimai-strategy input[type="number"] { width: 50px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; color: #fff; padding: 2px 4px; font-size: 12px; text-align: center; }',
      '.waimai-strategy-params { margin-left: 22px; padding: 2px 0 6px 0; font-size: 12px; color: #aaa; display: flex; align-items: center; gap: 4px; }',
      '.waimai-strategy-params span { font-size: 12px; }',
    ...
    panel.innerHTML = [
      ...
      '    <label><input type="radio" name="waimai-strategy" value="after_order" checked> 下单后</label>',
      '    <div class="waimai-strategy-params"><span>下单后 </span><input type="number" id="waimai-after-min-sec" value="240" min="0" max="1800">~<input type="number" id="waimai-after-max-sec" value="300" min="0" max="1800"> 秒</div>',
      '    <label><input type="radio" name="waimai-strategy" value="before_deadline"> 建议出餐前</label>',
      '    <div class="waimai-strategy-params"><span>建议出餐前 </span><input type="number" id="waimai-before-min-sec" value="120" min="0" max="600">~<input type="number" id="waimai-before-max-sec" value="180" min="0" max="600"> 秒</div>',
